      ...
      <form @submit.prevent="submitForm" class="bg-white p-6 rounded shadow-md grid grid-cols-1 md:grid-cols-2 gap-x-5">
        ...
        <div class="mb-4">
          ...
          <input type="text" id="city" v-model="formData.city"
            class="w-full px-4 py-2 border rounded focus:outline-none focus:border-blue-500" disabled
        ...
        <div class="mb-4 flex items-center">
          ...
          <div class="flex items-center" v-if="route.query.address_store_type !== 'shipping_new' && route.query.address_store_type !== 'billing_new'">
        ...
        <div class="mb-4 col-span-full">
          ...
          <div class="flex space-x-4">
            <button type="button" @click="setType('1')" class="px-4 py-2 border rounded focus:outline-none"
              :class="{ 'bg-blue-500 text-white': formData.type === '1' }">Home</button>
            <button type="button" @click="setType('2')" class="px-4 py-2 border rounded focus:outline-none"
              :class="{ 'bg-blue-500 text-white': formData.type === '2' }">Office</button>
            <button type="button" @click="setType('3')" class="px-4 py-2 border rounded focus:outline-none"
              :class="{ 'bg-blue-500 text-white': formData.type === '3' }">Other</button>
          </div>
        </div>
        ...
        <div class="mt-6 col-span-full">
          <button type="submit"
            class="w-full bg-blue-500 text-white py-2 rounded hover:bg-blue-600 focus:outline-none">Submit</button>
        </div>
      </form>
    </div>
  </div>
